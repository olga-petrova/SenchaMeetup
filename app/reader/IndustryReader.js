Ext.define('SenchaMeetup.reader.IndustryReader', {
    ...
    addTreeHierarchy: function (data, levels) {
        if (levels == 1) {
            return this.addTreeLevel(data, 'state', ['salary'], 'industry_record');
        } else {
            return this.addTreeLevel(this.addTreeLevel(data, 'industry_type', ['salary', 'state'], 'industry_record'), 'state', [], 'state');
        }
